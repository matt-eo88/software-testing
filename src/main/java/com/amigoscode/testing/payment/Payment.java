...
public class Payment {
    ...
    public Payment(Long paymentId, UUID customerId,
    ...
    public boolean equals(Object o) {
        ...
        if (!customerId.equals(payment.customerId)) return false;
        if (!amount.equals(payment.amount)) return false;
        if (currency != payment.currency) return false;
        if (!source.equals(payment.source)) return false;
        return description.equals(payment.description);
    }
